...
from .serializers import EmailTokenObtainPairSerializer, RegisterSerializer, UserSerializer, is_domain_allowed
        ...
        try:
            ...
            if user_info_response.status_code == 200:
                ...
                if not id_token or not google_requests:
                    return Response({'error': 'Google authentication library is not installed'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
